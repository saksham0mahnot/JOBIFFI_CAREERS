      ...
      <div className="max-w-7xl  py-10 mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10">
        ...
        <div>
          <ul className="mt-3 space-y-2 text-gray-600">
            <a href="/" className="text-gray-600 hover:text-blue-900 cursor-pointer block font-normal">
              Home
            </a>
            <a
              href="/about-us"
              rel="noopener noreferrer"
              className="text-gray-600 hover:text-blue-900 cursor-pointer block font-normal"
            >
              About us
            </a>
            {/* <li className="text-gray-600 hover:text-blue-900 cursor-pointer font-normal">About us</li> */}
            <li className="text-gray-600 hover:text-blue-900 cursor-pointer font-normal">Careers</li>
            <li className="text-gray-600 hover:text-blue-900 cursor-pointer font-normal">Hiring hub</li>
            <li className="text-gray-600 hover:text-blue-900 cursor-pointer font-normal">Sitemap</li>
          </ul>
        </div>
        ...
        <div>
          <ul className="mt-3 space-y-2 text-gray-600">
            <li className="text-gray-600 hover:text-blue-900 cursor-pointer font-normal">Jobs</li>
            <li className="text-gray-600 hover:text-blue-900 cursor-pointer font-normal">Compaines</li>
            <li className="text-gray-600 hover:text-blue-900 cursor-pointer font-normal">Services</li>
            <li className="text-gray-600 hover:text-blue-900 cursor-pointer font-normal">Resources</li>
            <li className="text-gray-600 hover:text-blue-900 cursor-pointer font-normal">Blogs</li>
          </ul>
        </div>
        ...
        <div>
          <ul className="mt-3 space-y-2 text-gray-600">
            <li className="text-gray-600 hover:text-blue-900 cursor-pointer font-normal">Help Center</li>
            ...
            <li className="text-gray-600 hover:text-blue-900 cursor-pointer font-normal">Fraud alert</li>

            <li className="text-gray-600 hover:text-blue-900 cursor-pointer font-normal">
              Trust & Safety
            </li>
          </ul>
        </div>
